...
manual_df = pd.read_excel("../data/manual_corrected.xlsx") # Your file CELL 2
...
df.to_csv("../data/raw_genai_data_manual.csv", index=False, encoding="utf-8")
print("📌 Saved → ../data/raw_genai_data_manual.csv")
